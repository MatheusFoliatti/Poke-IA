...
│   │   │   └── database.py
│   │   ├── schemas/
│   │   │   └── conversation.py        ← novo v2.1.0
│   │   ├── services/
│   │   │   ├── pokeapi.py
│   │   │   ├── chat_service.py
│   │   │   └── conversation_service.py ← novo v2.1.0
│   │   └── main.py
│   ├── alembic/
│   │   └── versions/
│   │       ├── 0eecc261f479_baseline.py
│   │       └── 5c40fd2edc57_add_conversations_table.py ← novo v2.1.0
│   ├── requirements.txt
│   └── .env
├── frontend/
│   ├── src/
...
│   │   │   ├── authStore.ts
│   │   │   ├── chatStore.ts
│   │   │   └── conversationStore.ts   ← novo v2.1.0
│   │   ├── types/
│   │   │   └── conversation.ts        ← novo v2.1.0
│   │   └── App.tsx
│   ├── package.json
│   └── .env
├── docker-compose.yml
